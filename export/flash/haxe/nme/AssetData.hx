...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/data/fire.mp3", nme.NME_assets_data_fire_mp3);
			...
			className.set ("assets/data/intro.mp3", nme.NME_assets_data_intro_mp3);
			...
			className.set ("assets/data/Piou.mp3", nme.NME_assets_data_piou_mp3);
			...
			className.set ("assets/enemi.png", nme.NME_assets_enemi_png);
			type.set ("assets/enemi.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/fire.png", nme.NME_assets_fire_png);
			type.set ("assets/fire.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/fond.png", nme.NME_assets_fond_png);
			...
			className.set ("assets/missile.png", nme.NME_assets_missile_png);
			type.set ("assets/missile.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/mis_fire.png", nme.NME_assets_mis_fire_png);
			type.set ("assets/mis_fire.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/nyancat.png", nme.NME_assets_nyancat_png);
			type.set ("assets/nyancat.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/openfl.svg", nme.NME_assets_openfl_svg);
			type.set ("assets/openfl.svg", Reflect.field (AssetType, "text".toUpperCase ()));
			className.set ("assets/plasma.png", nme.NME_assets_plasma_png);
			...
			className.set ("assets/space3.png", nme.NME_assets_space3_png);
...
class NME_assets_data_fire_mp3 extends flash.media.Sound { }
...
class NME_assets_data_intro_mp3 extends flash.media.Sound { }
...
class NME_assets_data_piou_mp3 extends flash.media.Sound { }
...
class NME_assets_enemi_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_fire_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_fond_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_haxeflixel_svg extends flash.utils.ByteArray { }
class NME_assets_missile_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_mis_fire_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_nyancat_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
